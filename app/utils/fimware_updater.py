...
def update_firmware_full(socket, device_id):
    ...
    try:
        ...
        # Check and set wifi credentials as environment variables. Since flasher script requires them as ENV variables,
        # and looks like Raspberry Pi OS do not allows to get wifi password to console, this trick is used here.
        ...
        process = subprocess.Popen([script_path, device_id], cwd=script_cwd, stdout=subprocess.PIPE, env=run_environment)
